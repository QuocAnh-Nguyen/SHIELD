"""Official Causal-HalBench metric (zhexu-ustc/Causal-HalBench) with CLI paths.

The official metric.py hardcodes qa_file/resp_file in __main__; the README
sanctions configuring those paths - here they are CLI arguments instead.
All metric logic is verbatim from the official implementation.
"""
...
if __name__ == "__main__":
    ...
    results = evaluate(args.qa_file, args.resp_file)
